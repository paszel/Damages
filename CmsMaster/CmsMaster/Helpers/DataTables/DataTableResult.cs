...
namespace CmsMaster.Helpers.DataTables
{
    /// <summary>
    ...
    public class DataTableResult : ActionResult, IDataTableResult<List<List<string>>>
    {
        ...
        public DataTableResult(Params dataTable, int iTotalRecords = 0, int iTotalDisplayRecords = 0, List<List<string>> aaData = null)
